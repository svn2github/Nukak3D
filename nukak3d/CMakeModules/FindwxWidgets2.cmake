...
IF(WIN32_STYLE_FIND)
  ...
  MACRO(WX_FIND_LIBS _UNV _UCD _DBG)
    ...
    FOREACH(LIB core adv html media xrc dbgrid gl qa aui)
      FIND_LIBRARY(WX_${LIB}${_DBG}
        NAMES
  ...
  IF(UNIX_STYLE_FIND)
    ...
    IF(wxWidgets_CONFIG_EXECUTABLE)
      ...
      EXEC_PROGRAM(${wxWidgets_CONFIG_EXECUTABLE}
        ...
        RETURN_VALUE RET)
      IF(RET EQUAL 0)
        # removes the -arch i386/ppc on MacOSX
        STRING(REGEX REPLACE "-arch [^ ;]+" "" wxWidgets_LIBRARIES "${wxWidgets_LIBRARIES}") 
        # removes the -isysroot  on MacOSX
        STRING(REGEX REPLACE "-isysroot [^ ;]+" "" wxWidgets_LIBRARIES "${wxWidgets_LIBRARIES}") 
...
IF  (wxWidgets_FOUND)
  ...
  SET(wxWidgets_USE_FILE "${wxWidgets_CURRENT_LIST_DIR}/UsewxWidgets2.cmake")
  # check
